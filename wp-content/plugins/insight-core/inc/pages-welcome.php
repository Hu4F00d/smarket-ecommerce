	...
	if ( InsightCore::is_theme_support() ) {
		...
		<div class="insight-core-body">
			...
			<div class="box green box-purchase">
				...
				<div class="box-body">
					<?php if ( get_option( 'insight_core_purchase_info' ) ) {
				...
				?>
						...
						<div class="purchase-desc">
							Show us your ThemeForest’s purchase code to get all awesome plugins & features.
						</div>
					<?php } ?>
				</div>
			</div>
					...
					if ( is_array( $check_theme_update ) && count( $check_theme_update ) > 0 ) {
						...
						<div class="update-info">
							...
							<div class="update-text">
								...
								<?php echo $check_theme_update["version"]; ?>
							</div>
						</div>
						<div class="update-text">
						...
						<div class="update-action">
							<a href="<?php echo admin_url( "admin.php?page=insight-core-update" ); ?>"
							   class="btn">Update</a>
						</div>
						<?php
					} else {
