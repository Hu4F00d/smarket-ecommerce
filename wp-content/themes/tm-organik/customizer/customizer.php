...
Kiki::add_section( 'topbar', array(
	...
	'description' => esc_html__( 'Control the top bar layout, spacing, typography and color. Top Bar just appear on Header Type 02', 'tm-organik' ),
	'priority'    => $priority ++,
) );
...
Kiki::add_section( 'custom_code', array(
	'title'       => esc_html__( 'Custom Code', 'tm-organik' ),
	'description' => esc_html__( 'Control the custom CSS and JS code.', 'tm-organik' ),
	'priority'    => $priority ++,
) );
