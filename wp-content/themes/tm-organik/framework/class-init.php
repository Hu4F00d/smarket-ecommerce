...
class Insight_Init {
	...
	function widgets_init() {
		...
		register_sidebar( array(
			'id'            => 'header-01_left',
			'name'          => esc_html__( 'Header 01 Left', 'tm-organik' ),
			'description'   => esc_html__( 'Add widgets here.', 'tm-organik' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h3 class="widget-title">',
	...
	public function core_info( $info ) {
		...
		$info['docs']    = 'http://document.thememove.com/organik-document';
		$info['api']     = 'http://api.insightstud.io/update/organik';
		...
		$info['tf']      = 'https://themeforest.net/item/organik-an-appealing-organic-food-shop-farm-woocomerce-theme/17678863';
