...
class Insight {
	...
	public static function page_title() {
		if ( is_search() || ( Insight_Helper::get_post_meta( 'title_visibility' ) == 'default' ) || ( Insight_Helper::get_post_meta( 'title_visibility' ) == '' ) ) {
		...
		if ( $show_title == '1' ) {
			if ( is_home() || is_front_page() ) {
				echo '<div class="page-title"><div class="container"><div class="title">' . esc_html__( 'Home', 'tm-organik' ) . '</div></div></div>';
	...
	public static function breadcrumbs() {
		if ( is_search() || ( Insight_Helper::get_post_meta( 'breadcrumbs_visibility' ) == 'default' ) || ( Insight_Helper::get_post_meta( 'breadcrumbs_visibility' ) == '' ) ) {
		...
		if ( $breadcrumbs_visibility != 'hidden' ) {
			if ( function_exists( 'insight_core_breadcrumb' ) ) {
				...
				echo wp_kses( insight_core_breadcrumb( array( 'home_label' => esc_html__( 'Home', 'tm-organik' ) ) ), array(
					'ul' => array(
						'class' => array(),
					),
					'li' => array(
