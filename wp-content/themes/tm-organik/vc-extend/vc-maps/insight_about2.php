		...
		array(
			...
			'value'       => array(
				'about_2_big_image'   => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/about-2/big-image.png',
					'title' => 'Big image',
				),
				'icon_on_small_image' => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/about-2/small-image.png',
					'title' => 'Small image',
				),
			),
