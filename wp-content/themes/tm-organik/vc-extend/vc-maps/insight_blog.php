...
vc_map( array(
	...
	'params'                    => array(
		array(
			...
			'value'       => array(
				'list'             => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/blog/blog_list.jpg',
					'title' => 'List',
				),
				'grid'             => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/blog/blog_grid.png',
					'title' => 'Grid',
				),
				'grid_has_padding' => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/blog/blog_grid-padding.png',
