...
$base_name = 'insight_featured_product';
...
vc_map( array(
	...
	'params'                    => array(
		array(
			...
			'value'       => array(
				'default'  => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/featured-product/1.png',
					'title' => 'Default',
				),
				'style-02' => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/featured-product/2.png',
					'title' => 'Style 02',
				),
				'style-03' => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/featured-product/3.png',
					'title' => 'Style 03',
				),
				'style-04' => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/featured-product/4.png',
					'title' => 'Style 04',
				),
				'style-05' => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/featured-product/5.png',
					'title' => 'Style 05',
				),
				'style-06' => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/featured-product/6.png',
					'title' => 'Style 06',
				),
				'style-07' => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/featured-product/7.png',
					'title' => 'Style 07',
				),
			),
			'std'         => 'default',
