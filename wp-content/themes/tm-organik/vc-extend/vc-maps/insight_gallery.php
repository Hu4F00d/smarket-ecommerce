...
vc_map( array(
	...
	'params'                    => array(
		array(
			...
			'value'       => array(
				'grid'    => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/gallery/grid.png',
					'title' => 'Grid',
				),
				'masonry' => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/gallery/masonry.png',
					'title' => 'Masonry',
				),
				'std'     => 'grid',
			),
