...
vc_map( array(
	...
	'params'                    => array(
		...
		array(
			...
			'value'       => array(
				'icon_on_left'  => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/icon-boxes/icon-on-left.png',
					'title' => 'Icon on Left',
				),
				'icon_on_top'   => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/icon-boxes/icon-on-top.png',
					'title' => 'Icon on Top',
				),
				'icon_on_right' => array(
					'img'   => INSIGHT_CHILD_THEME_URI . '/assets/admin/images/shortcode-style/icon-boxes/icon-on-right.png',
					'title' => 'Icon on Right',
				),
			),
			'std'         => 'icon_on_left',
