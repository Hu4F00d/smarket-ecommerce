...
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo esc_attr( $product_id ); ?>">
	<?php if ( ! ( $disable_wishlist && ! is_user_logged_in() ) ) { ?>
		<div
			class="hint--top hint--rounded hint--bounce yith-wcwl-add-button <?php echo ( $exists && ! $available_multi_wishlist ) ? 'hide' : 'show'; ?>"
			aria-label="<?php esc_attr_e( 'Add to wishlist', 'tm-organik' ) ?>"
		...
		<div class="hint--top hint--rounded hint--bounce yith-wcwl-wishlistaddedbrowse hide"
		     aria-label="<?php esc_attr_e( 'Browse wishlist', 'tm-organik' ) ?>"
		     style="display:none;">
		...
		<div
			class="hint--top hint--rounded hint--bounce yith-wcwl-wishlistexistsbrowse <?php echo ( $exists && ! $available_multi_wishlist ) ? 'show' : 'hide'; ?>"
			aria-label="<?php esc_attr_e( 'Browse wishlist', 'tm-organik' ) ?>"
	...
	<?php } else { ?>
		<a href="<?php echo esc_url( add_query_arg( array(
		   ...
		   class="hint--top hint--rounded hint--bounce <?php echo str_replace( 'add_to_wishlist', '', $link_classes ); ?>"
		   aria-label="<?php esc_attr_e( 'Add to wishlist', 'tm-organik' ); ?>"
